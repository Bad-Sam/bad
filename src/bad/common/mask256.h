...
static bad_forceinline void bad_veccall mask256_store(u32* mem_addr, mask256 a);
static bad_forceinline void bad_veccall mask256_storeu(u32* mem_addr, mask256 a);
